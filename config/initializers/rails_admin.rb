# RailsAdmin config file. Generated on November 24, 2011 14:34
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Bluey', 'Admin']
  ...
  # config.model Aliment do
  #   # Found associations:
  #     field :meal, :belongs_to_association 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  ...
  # config.model Day do
  #   # Found associations:
  #     field :plan, :belongs_to_association 
  #     field :plan_items, :has_many_association 
  #     field :meals, :has_many_association 
  #     field :versions, :has_many_association         # Hidden 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  #     field :number, :integer 
  #     field :plan_id, :integer         # Hidden 
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #     field :show_flag, :boolean 
  #     field :state, :string 
  #   # Sections:
  #   list do; end
  #   export do; end
  ...
  # config.model Meal do
  #   # Found associations:
  #     field :day, :belongs_to_association 
  #     field :aliments, :has_many_association 
  #     field :versions, :has_many_association         # Hidden 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  #     field :day_id, :integer         # Hidden 
  ...
  #   # Found associations:
  #     field :creator, :belongs_to_association 
  #     field :plan_type, :belongs_to_association 
  #     field :days, :has_many_association 
  #     field :plan_items, :has_many_association 
  #     field :meals, :has_many_association 
  #     field :plan_item_versions, :has_many_association         # Hidden 
  #     field :versions, :has_many_association         # Hidden 
  ...
  #     field :id, :integer 
  #     field :name, :string 
  #     field :creator_id, :integer         # Hidden 
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #     field :description, :text 
  #     field :plan_type_id, :integer         # Hidden 
  ...
  # config.model PlanItem do
  #   # Found associations:
  #     field :day, :belongs_to_association 
  #     field :plan_item_sets, :has_many_association 
  #     field :plan_item_image, :has_one_association 
  #     field :versions, :has_many_association         # Hidden 
  #   # Found columns:
  #     field :id, :integer 
  #     field :created_at, :datetime 
  ...
  # config.model PlanItemImage do
  #   # Found associations:
  #     field :plan_item, :belongs_to_association 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  #     field :plan_item_id, :integer         # Hidden 
  ...
  #   # Found associations:
  #     field :plan, :has_many_association 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  ...
  #     field :goal_value, :decimal 
  #     field :unit, :string 
  #     field :is_goal, :boolean 
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #     field :user_profile_id, :integer         # Hidden 
  #     field :body_part_id, :integer         # Hidden 
  #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  ...
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #     field :picture_file_name, :string         # Hidden 
  #     field :picture_content_type, :string         # Hidden 
  #     field :picture_file_size, :integer         # Hidden 
  #     field :picture_updated_at, :datetime         # Hidden 
  #     field :picture, :paperclip 
  #     field :is_profile_picture, :boolean 
  #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  ...
  #     field :user_wants, :has_and_belongs_to_many_association 
  #     field :user_images, :has_many_association 
  #     field :user_goals, :has_many_association 
  #     field :user_pains, :has_many_association 
  #     field :body_parts, :has_many_association 
  #   # Found columns:
  #     field :id, :integer 
  #     field :name, :string 
  #     field :summary, :text 
